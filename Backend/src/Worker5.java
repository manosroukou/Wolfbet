...
public class Worker5 {
    ...
    public static void main(String[] args) {
        ...
        int workerPort = Integer.parseInt(prop.getProperty("worker5.port"));
        int healthPort = Integer.parseInt(prop.getProperty("worker5.healthport"));
        ...
        try (ServerSocket serverSocket = new ServerSocket(workerPort)) {
            System.out.println("Worker 5 started at port " + workerPort);
