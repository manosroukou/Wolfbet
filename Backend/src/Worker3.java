...
public class Worker3 {
    ...
    public static void main(String[] args) {
        ...
        int workerPort = Integer.parseInt(prop.getProperty("worker3.port"));
        int healthPort = Integer.parseInt(prop.getProperty("worker3.healthport"));
        ...
        try (ServerSocket serverSocket = new ServerSocket(workerPort)) {
            System.out.println("Worker 3 started at port " + workerPort);
