...
public class Worker2 {
    ...
    public static void main(String[] args) {
        ...
        int workerPort = Integer.parseInt(prop.getProperty("worker2.port"));
        int healthPort = Integer.parseInt(prop.getProperty("worker2.healthport"));
        ...
        try (ServerSocket serverSocket = new ServerSocket(workerPort)) {
            System.out.println("Worker 2 started at port " + workerPort);
