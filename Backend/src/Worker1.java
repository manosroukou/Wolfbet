...
public class Worker1 {
    ...
    public static void main(String[] args) {
        ...
        int workerPort = Integer.parseInt(prop.getProperty("worker1.port"));
        int healthPort = Integer.parseInt(prop.getProperty("worker1.healthport"));
        ...
        try (ServerSocket serverSocket = new ServerSocket(workerPort)) {
            System.out.println("Worker 1 started at port " + workerPort);
